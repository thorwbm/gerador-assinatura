...
public class GeradorAssinatura {
	...
	public void criarAssinatura(Pessoa pessoa) {		
		try {
		BufferedImage logo = ImageIO.read(getClass().getResourceAsStream("/image/" + pessoa.getInstituto().getLogo() + ".png"));
		...
		ImageIO.write(assinatura, "png", new File("D:\\temp\\assinatura\\ASSINATURA" + primeiroNome(pessoa.getNome()) + ".png"));


		} catch (IOException e) {
			System.out.println("Arquivo corrompido ou inesistente.");
		}
	}
