...
public  abstract class AssinaturaForm extends JFrame{
	...
	protected JLabel lblSetor;
	protected JTextField txtSetor;
	...
	public JPanel getPnlForm() {
		if(pnlForm == null) {
			...
			String[] comboMensagens = {"CSC","HUCM","IPG"};
			lblNome = new JLabel("Nome");
			txtNome = new JTextField(TAMANHO_TXT);
			
			lblSetor = new JLabel("Setor");
			txtSetor = new JTextField(TAMANHO_TXT);
			...
			pnlForm.add(lblSetor);
			pnlForm.add(txtSetor);
